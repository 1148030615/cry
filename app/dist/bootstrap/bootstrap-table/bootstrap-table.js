...
!function ($) {
    ...
    var cellHeight = 41, // update css if changed
        cachedWidth = null,
    ...
    BootstrapTable.DEFAULTS = {
        ...
        onRemoveRow: function (index, row) {
            return false;
        }
    };
    ...
    BootstrapTable.EVENTS = {
        ...
        'removeRow.bs.table': 'onRemoveRow'
    };
    ...
    BootstrapTable.prototype.initHeader = function () {
        ...
        if (!this.options.showHeader || this.options.cardView) {
            ...
            this.$tableLoading.css('padding-top', 5 + 'px');
    ...
    BootstrapTable.prototype.initBody = function (fixedScroll) {
        ...
        // show no records
        if (!html.length && !this.options.noPlaceHolder) {
    ...
    BootstrapTable.prototype.remove = function (params) {
        ...
        this.initPagination();
        this.initBody(true);
        this.trigger('removeRow', params.values, row);
    };
    ...
    // jetHis
    BootstrapTable.prototype.onRemoveRow = function () {
